    ...
    <section className="py-16 bg-background">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-3xl lg:text-4xl font-bold text-foreground mb-4 text-balance">Brand Features</h2>
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto text-pretty">
            Everything you need to know about {brand.name} vehicles in our fleet.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <Card>
            <CardContent className="p-6">
              ...
              <div className="space-y-3">
                {brand.inclusions.map((inclusion, index) => (
          ...
          <Card>
            <CardContent className="p-6">
              ...
              <div className="space-y-3">
                {brand.exclusions.map((exclusion, index) => (
                  <div key={index} className="flex items-center space-x-3">
