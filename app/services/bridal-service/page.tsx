        ...
        <div className="container mx-auto px-4 py-6">
          <Breadcrumb>
            <BreadcrumbList>
              ...
              <BreadcrumbSeparator />
              <BreadcrumbItem>
                <BreadcrumbPage>Bridal Service</BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
        </div>
            ...
            <div className="max-w-4xl mx-auto space-y-12">
              ...
              <Card>
                <CardContent className="p-8">
                  <h2 className="text-3xl font-bold text-foreground mb-6">About Bridal Service</h2>
              ...
              <Card>
                <CardContent className="p-8">
                  <h2 className="text-3xl font-bold text-foreground mb-6">Why Choose Our Bridal Service?</h2>
                  <div className="space-y-4 text-muted-foreground leading-relaxed">
              ...
              <Card>
                <CardContent className="p-8">
                  <h2 className="text-3xl font-bold text-foreground mb-6">How Bridal Service Works</h2>
                  <div className="space-y-4 text-muted-foreground leading-relaxed">
